...
def start_genetique():
    ...
    while actual_generation < const.NUMBER_MAX_GENERATION:
        ...
        print("Generation : {0} | Best : {1} | Mean : {2:.2f}".format(generation.get_generation_number(),
                                                                      generation.get_best_solution().get_distance(),
                                                                      generation.mean_distance()))
    ...
    print(generation.get_best_solution().get_individu_list())
